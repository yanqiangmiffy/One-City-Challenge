...
def get_clean(text):
    ...
    return text[:300]
train_df=pd.read_csv('data/train_set_v8.csv',lineterminator='\n')
test=pd.read_csv('data/test_set_v8.csv',lineterminator='\n')
...
np.save('result/09_chinese-roberta-wwm-ext_p8.npy', raw_outputs)
sub.to_csv('result/09_chinese-roberta-wwm-ext_p8.csv', index=False)
